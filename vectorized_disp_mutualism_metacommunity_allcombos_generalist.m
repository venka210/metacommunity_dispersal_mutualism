...
%q = 0.45;
d_m = 1; a = 0.8;%reducing 'a' reduces dispersal rates where px > py
del_m = 2:0.5:18; %I'm only not starting from zero because the computational costs are absurd
...
f = 0.47; % f is the fraction of diet consumed by frugivore that consists of 'x'. (1-f) is fraction that is 'y'
